...
class ResponseRetrieval:
    def __init__(self, from_date, to_date, page_number=0):
        ...
        #self._url = f"https://www.statstidende.dk/messages?fromDate=2022-09-01T00%3A00%3A00&m=14a1d71df21558e5ade0214f90482cdc&ps=100&toDate=2022-12-05T00%3A00%3A00"
